...
dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(id = "sidebar",
                ...
                conditionalPanel("input.sidebar == 'viz' && input.t2 == 'trends' ", selectInput(inputId = "var2" , label ="Pilih Variabel Polusi Udara" , choices = c2)),
    ...
    tabItems(
      ...
      tabItem(
        ...
        box(
          ...
          selectInput("airpollution", "Pilih Variabel", choices = c2, selected = "CO", width = 250),
